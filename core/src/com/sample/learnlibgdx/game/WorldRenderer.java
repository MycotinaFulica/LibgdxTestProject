...
public class WorldRenderer implements Disposable
{
    ...
    private void renderGuiScore (SpriteBatch batch) {
        float x = 0;
        float y = 10;
        float originX = Assets.instance.goldCoin.goldCoin.getRegionWidth()/2;
        float originY = Assets.instance.goldCoin.goldCoin.getRegionHeight()/2;
        batch.draw(Assets.instance.goldCoin.goldCoin,
                x, y, originX, originY, 100, 100, 0.35f, -0.35f, 0);
        Assets.instance.fonts.defaultBig.draw(batch,"" + worldController.score, x + 65, y + 10);
    }
