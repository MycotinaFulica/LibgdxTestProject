...
public class Rock extends AbstractGameObject
{
    ...
    private void init () {
        ...
        regEdge = Assets.instance.rock.edge; //Assets is initialized at onCreate Method of the core module
    ...
    public void render (SpriteBatch batch) {
        ...
        batch.draw(reg.getTexture(),position.x + relX, position.y + relY, origin.x + dimension.x / 8, origin.y, dimension.x / 4,
                dimension.y, scale.x, scale.y, rotation, reg.getRegionX(), reg.getRegionY(), reg.getRegionWidth(), reg.getRegionHeight(), true, false);
    }
    ...
    public void update(float deltaTime) {
        ...
        if (floatCycleTimeLeft<= 0) {
            ...
            Gdx.app.log("LERPROCK", "POSITION Y : + " + floatTargetPosition.y);
        }
